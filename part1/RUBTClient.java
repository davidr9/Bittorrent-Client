...
public class RUBTClient {
	...
	public static void main(String[] args) throws UnknownHostException, IOException, NullPointerException, BencodingException {
		...
		System.out.println("trackerResponse length is: " + trackerResponse.length);	 
		decodeTrackerResponse(trackerResponse);
		System.out.println("AFTER DECODE CALL");
...
https://wiki.theory.org/BitTorrentSpecification*/
	...
	private static void decodeTrackerResponse(byte[] tracker_response) throws BencodingException, IOException{
		/*
		...
		System.out.println("complete: " + decodedResponse.complete);
		System.out.println("incomplete: " + decodedResponse.incomplete);
		System.out.println("interval: " + decodedResponse.interval);
